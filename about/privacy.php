...
if ($agent_is_mobile && !$server_is_mobile) {
	header('Location: http://m.calltia.com/about/privacy.php');
	exit;
}
if (!$agent_is_mobile && $server_is_mobile) {
	header('Location: http://calltia.com/about/privacy.php');
	exit;
}
...
<div data-role="content" id="content">
	...
	<p><?=nl2br(trim($common[$selected_lang]['privacy_policy']['title']))?></p>
